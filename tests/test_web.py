...
class WebTests(unittest.TestCase):
    ...
    def test_status_exposes_controller_diagnostics(self) -> None:
        ...
        self.assertEqual(data["active_controller"], "baseline_hysteresis")
    ...
    def test_config_form_uses_adc_names_and_persists_address(self) -> None:
        ...
        response = self.client.post(
            ...
            data={
                ...
                "watering_enabled": "on",
                "controller_active": "baseline_hysteresis",
                "baseline_hysteresis_watering_cooldown_seconds": "1800",
            },
        )
        ...
        self.assertEqual(
            saved["controller"]["active"], "baseline_hysteresis"
        )
        self.assertEqual(
            saved["controllers"]["baseline_hysteresis"][
